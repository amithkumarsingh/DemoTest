...
public class DashBoardQuickActionViewItem {
    ...
    public DashBoardQuickActionViewItem(String quickActionName, String quickActionIcon, int quickActionId, int quickActionHiddenForDoctorOnly) {
        this.quickActionName = quickActionName;
        this.quickActionIcon = quickActionIcon;
        this.quickActionId = quickActionId;
        this.quickActionHiddenForDoctorOnly = quickActionHiddenForDoctorOnly;
