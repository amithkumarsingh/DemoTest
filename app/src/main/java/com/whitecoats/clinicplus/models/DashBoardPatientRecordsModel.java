...
public class DashBoardPatientRecordsModel {
    ...
    public String getSharedOnDateTime() {
        return sharedOnDateTime;
    }

    public void setSharedOnDateTime(String sharedOnDateTime) {
        this.sharedOnDateTime = sharedOnDateTime;
    }

    String sharedOnDateTime;

    public JSONObject getRecordDetailsObject() {
        return recordDetailsObject;
    }

    public void setRecordDetailsObject(JSONObject recordDetailsObject) {
        this.recordDetailsObject = recordDetailsObject;
    }

    JSONObject recordDetailsObject;

    public JSONObject getFieldDictionaryObject() {
        return fieldDictionaryObject;
    }

    public void setFieldDictionaryObject(JSONObject fieldDictionaryObject) {
        this.fieldDictionaryObject = fieldDictionaryObject;
    }

    JSONObject fieldDictionaryObject;
