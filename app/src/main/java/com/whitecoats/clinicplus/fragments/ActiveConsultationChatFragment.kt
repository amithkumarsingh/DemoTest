...
class ActiveConsultationChatFragment(getClinicData: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.list_row_active_con_chat, container, false)
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationChatFragment {
            val fragment =
                ActiveConsultationChatFragment(clinicData!!, productArrayPos)
            val args = Bundle()
