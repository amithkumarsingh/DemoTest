...
class ActiveConsultationClinicFiveFragment(clinicDataObj: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationClinicFiveFragment {
            val fragment = ActiveConsultationClinicFiveFragment(
                clinicData!!,
                productArrayPos
            )
            val args = Bundle()
