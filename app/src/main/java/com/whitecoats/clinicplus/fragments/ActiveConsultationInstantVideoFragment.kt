...
class ActiveConsultationInstantVideoFragment(clinicDataObj: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.list_row_active_con_instant_video, container, false)
        ...
        try {
            serviceNameText.text = "" + productObject!!.getString("name")
            pendingLeftRupeeText.text = "" + productObject!!.getString("received")
        } catch (e: JSONException) {
            e.printStackTrace()
        }
        return view
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationInstantVideoFragment {
            val fragment = ActiveConsultationInstantVideoFragment(
                clinicData!!,
                productArrayPos
            )
            val args = Bundle()
