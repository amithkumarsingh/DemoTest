...
class ActiveConsultationClinicThreeFragment(clinicDataObj: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationClinicThreeFragment {
            val fragment = ActiveConsultationClinicThreeFragment(
                clinicData!!,
                productArrayPos
            )
            val args = Bundle()
