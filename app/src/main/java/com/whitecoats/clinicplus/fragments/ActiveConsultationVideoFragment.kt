...
class ActiveConsultationVideoFragment(clinicDataObj: JSONArray,productArrayPosition: Int) :
    Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.list_row_active_con_video, container, false)
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationVideoFragment {
            val fragment =
                ActiveConsultationVideoFragment(clinicData!!, productArrayPos)
            val args = Bundle()
