...
class ActiveConsultationClinicTwoFragment(clinicDataObj: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationClinicTwoFragment {
            val fragment =
                ActiveConsultationClinicTwoFragment(clinicData!!, productArrayPos)
            val args = Bundle()
