...
class ActiveConsultationClinicSixFragment( clinicDataObj: JSONArray,  productArrayPosition: Int) :
    Fragment() {
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationClinicSixFragment {
            val fragment =
                ActiveConsultationClinicSixFragment(clinicData!!, productArrayPos)
            val args = Bundle()
