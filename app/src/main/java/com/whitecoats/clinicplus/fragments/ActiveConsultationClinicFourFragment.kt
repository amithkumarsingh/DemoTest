...
class ActiveConsultationClinicFourFragment(clinicDataObj: JSONArray, productArrayPosition: Int) :
    Fragment() {
    ...
    companion object {
        ...
        fun newInstance(): ActiveConsultationClinicFourFragment {
            val fragment = ActiveConsultationClinicFourFragment(
                clinicData!!,
                productArrayPos
            )
            val args = Bundle()
