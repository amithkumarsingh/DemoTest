...
class PaymentsRefundOverViewBtmSheet : BottomSheetDialogFragment() {
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        val contentView =
            View.inflate(context, R.layout.fragment_bottom_sheet_refund_overview, null)
        dialog.setContentView(contentView)
        val params = (contentView.parent as View).layoutParams as CoordinatorLayout.LayoutParams
        val behavior = params.behavior
        cancelIcon = contentView.findViewById(R.id.bottomSheetRefundCancelIcon)
        close_layout = contentView.findViewById(R.id.layout_refund_close)
