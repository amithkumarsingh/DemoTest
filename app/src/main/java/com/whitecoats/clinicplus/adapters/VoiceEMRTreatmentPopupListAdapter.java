...
public class VoiceEMRTreatmentPopupListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  VoiceEMRModel emrObject;
    private List<EMRAddRecordCategoryModel> voiceEMRModelsTreatmentPopupCategoryList;
    private VoiceEmrRecordClickListener voiceEmrRecordClickListener;
    private Context context;

    public VoiceEMRTreatmentPopupListAdapter(Context context, List<EMRAddRecordCategoryModel> voiceEMRModelsVitalsPopupCategoryList,VoiceEMRModel voiceEMRModel, VoiceEmrRecordClickListener voiceEmrRecordClickListener) {

        this.context = context;
        this.voiceEMRModelsTreatmentPopupCategoryList = voiceEMRModelsVitalsPopupCategoryList;
        this.voiceEmrRecordClickListener = voiceEmrRecordClickListener;
        this.emrObject=voiceEMRModel;
    }
    ...
    public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder, int position) {
        MyViewHolder itemViewHolder = (MyViewHolder) holder;
            ...
            itemViewHolder.vitalCategoryName.setText(voiceEMRModelsTreatmentPopupCategoryList.get(position).getCategoryName());

//        itemViewHolder.categoryNameLinearLayoutCompact.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                voiceEmrRecordClickListener.onItemClick(view, position, voiceEMRModelsTreatmentPopupCategoryList.get(position).getCategoryId(), voiceEMRModelsTreatmentPopupCategoryList.get(position).getCategoryName());
//            }
//        });
        itemViewHolder.radioButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                voiceEmrRecordClickListener.onItemClick(view, position, voiceEMRModelsTreatmentPopupCategoryList.get(position).getCategoryId(), voiceEMRModelsTreatmentPopupCategoryList.get(position).getCategoryName(), emrObject, "");
            }
        });
    ...
    public int getItemCount() {
        return voiceEMRModelsTreatmentPopupCategoryList.size();
//        return 5;
    }
