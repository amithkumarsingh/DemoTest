...
public class AppointmentEpisodeActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_episode);
...
//                    getEpisPDF();
                    ...
                    Toast.makeText(AppointmentEpisodeActivity.this, getResources().getString(R.string.no_data_found), Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                getEpisEvalutaion();
        ...
        notesAddNew.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AppointmentEpisodeActivity.this, PatientCreateRecordActivity.class);
...
//                        Log.d("Share Data", shareObj.toString());
                        ...
                        Toast.makeText(AppointmentEpisodeActivity.this, "Please select one interaction", Toast.LENGTH_SHORT).show();
                    }
...
//        cb.setOnCheckedChangeListener(AppointmentEpisodeActivity.this);
        ...
        selectedEcntArrTwo.add(cb.getId());
...
//                        Toast.makeText(PatientEpisodeActivity.this, getResources().getString(R.string.no_data_found), Toast.LENGTH_SHORT).show();
            ...
            public void onError(String err) {
                ...
                ErrorHandlerClass.INSTANCE.errorHandler(AppointmentEpisodeActivity.this, err);
...
//            startActivity(intent);
            ...
            Toast.makeText(AppointmentEpisodeActivity.this, "Please select one interaction before adding a record", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        apiCall.postRecords(ApiUrls.shareEpisodeData, shareObj, this, new VolleyCallback() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    Toast.makeText(AppointmentEpisodeActivity.this, respObj.getString("response"), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                    Toast.makeText(AppointmentEpisodeActivity.this, "Error Occurred. Try again later", Toast.LENGTH_SHORT).show();
                }
            }
