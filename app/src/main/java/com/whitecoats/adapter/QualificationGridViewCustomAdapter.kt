...
class QualificationGridViewCustomAdapter(
    activity: Activity,
    private val result: List<SettingProfesionalModel>,
    qualificationClickListner: PatientRecordListener
) : BaseAdapter() {
    var context: Context
    private val qualificationClickListner: PatientRecordListener

    init {
        // TODO Auto-generated constructor stub
        context = activity
        inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        this.qualificationClickListner = qualificationClickListner
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.tv!!.text = result[position].qualificationName

        holder.img!!.setOnClickListener { view ->
            qualificationClickListner.onItemClick(view, position.toString(), "QUAL_REMOVE", "")
        }
        return rowView
    }
