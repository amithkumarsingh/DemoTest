...
class SettingObservationListAdapter(private val settingObserModelList: MutableList<SettingObservationModel>?, private val mContext: Context, private val obserListener: SettingObserItemClickListener) : RecyclerView.Adapter<SettingObservationListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(myViewHolder: MyViewHolder, i: Int) {
        ...
        if (settingObserModel.categoryStatus == true) {
        ...
        myViewHolder.enableDisable.setOnClickListener { v ->
            ...
            obserListener.onItemClick(v, i, obserStatus, categegoryId, "observation")
        }
    }
