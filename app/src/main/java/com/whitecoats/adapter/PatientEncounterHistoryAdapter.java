...
public class PatientEncounterHistoryAdapter extends RecyclerView.Adapter<PatientEncounterHistoryAdapter.MyViewHolder> {

    private List<PatientRecordsModel> patientRecordsModels;
    private Activity activity;
    private AppUtilities appUtilities;

    public PatientEncounterHistoryAdapter(List<PatientRecordsModel> patientRecordsModels, Activity activity) {
    ...
    @NonNull
    @Override
    public PatientEncounterHistoryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_row_record_encounters, viewGroup, false);
        return new PatientEncounterHistoryAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final PatientEncounterHistoryAdapter.MyViewHolder myViewHolder, int i) {
...
//            }
            ...
            if (PatientRecordsCaseActivity.historyTabClick == 1) {
                myViewHolder.treatPlanAddNew.setVisibility(View.GONE);
            } else {
                myViewHolder.treatPlanAddNew.setVisibility(View.VISIBLE);
