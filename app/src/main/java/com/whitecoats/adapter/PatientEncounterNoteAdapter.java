...
public class PatientEncounterNoteAdapter extends RecyclerView.Adapter<PatientEncounterNoteAdapter.MyViewHolder> {

    private List<PatientRecordsModel> patientRecordsModels;
    private Activity activity;
    private AppUtilities appUtilities;

    public PatientEncounterNoteAdapter(List<PatientRecordsModel> patientRecordsModels, Activity activity) {
    ...
    @NonNull
    @Override
    public PatientEncounterNoteAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_row_record_encounters, viewGroup, false);
        return new PatientEncounterNoteAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final PatientEncounterNoteAdapter.MyViewHolder myViewHolder, int i) {
        ...
        if (recordsModel.getType() == 1) {
            ...
            myViewHolder.viewPdf.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - PDF View");
                    PatientRecordsCaseActivity episodeActivity = (PatientRecordsCaseActivity) activity;
            ...
            myViewHolder.viewNotes.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Written Notes - View Notes");
                    PatientRecordsCaseActivity episodeActivity = (PatientRecordsCaseActivity) activity;
...
//            myViewHolder.firstSeen.setText("First Recorded On: " + temp);
            ...
            myViewHolder.investViewFile.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Investigation - File View");
...
//            temp = appUtilities.changeDateFormat("yyyy-MM-dd mm:HH:ss", "dd MMM, yy mm:HH", recordsModel.getDiagConfirmed());
...
//            }
            ...
            myViewHolder.treatPlanAddNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Treatment Plan - Add New");
                    PatientRecordsCaseActivity patientEpisodeActivity = (PatientRecordsCaseActivity) activity;
            ...
            myViewHolder.treatPlanLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (recordsModel.getTreatPlanCount() != 0) {
                        ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Treatment Plan - View Data");
                        PatientRecordsCaseActivity patientEpisodeActivity = (PatientRecordsCaseActivity) activity;
...
//            }
            ...
            if (PatientRecordsCaseActivity.historyTabClick == 1) {
                myViewHolder.obsAddNew.setVisibility(View.GONE);
            } else {
                myViewHolder.obsAddNew.setVisibility(View.VISIBLE);
            ...
            myViewHolder.obsAddNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Evaluation - Observation - Add New");
                    PatientRecordsCaseActivity patientEpisodeActivity = (PatientRecordsCaseActivity) activity;
            ...
            myViewHolder.obsLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (recordsModel.getObsCount() != 0) {
                        ZohoSalesIQ.Tracking.setCustomAction("AppointmentNotes - Evaluation - Observation - View Data");
                        PatientRecordsCaseActivity patientEpisodeActivity = (PatientRecordsCaseActivity) activity;
